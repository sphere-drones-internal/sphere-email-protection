...
// strict CSP in src/middleware.ts doesn't need a font-src exception for a Google CDN.
...
// Every route here is processed by src/middleware.ts and gets a fresh CSP nonce
